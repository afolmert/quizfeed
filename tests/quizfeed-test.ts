...
describe('quizfeed.Entry', function () {
    ...
    it('should exist', function (done) {
        var entry: quizfeed.Entry = new quizfeed.Entry('q', 'a');
        done();
    });
...
describe('quizfeed.Option', function () {
    ...
    it('should exist', function (done) {
        var option: quizfeed.Option = new quizfeed.Option();
        done();
    });

    it('should be able to parse simple options ', function(done) {
        var option: quizfeed.Option = quizfeed.Option.parse('#![hello]');
...
describe('quizfeed.Context', function () {
	...
	it('should parse swap option', function(done) {
		var context: quizfeed.Context = new quizfeed.Context();
